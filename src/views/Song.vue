  ...
  <main>
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        >
          <i
            :class="{ 'fas fa-play': !playing, 'fas fa-pause': playing }"
          />
        </button>
...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_msg: 'Pease wait! Your comment is being submitted',
      comments: [],
      sort: '1',
    };
  },
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_msg = 'Pease wait! Your account is being created';
