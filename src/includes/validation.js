    ...
    configure({
      generateMessage: (ctx) => {
        const messages = {
          ...
          alpha_spaces: `The field ${ctx.field} may only contain alphbetical characters and spaces`,
          email: `The ${ctx.field} must ve a valid email`,
          min_value: `The ${ctx.field} is too low`,
          max_value: `The ${ctx.field} is too high`,
          excluded: `Ypu are not allowed to use this value for the field ${ctx.field}`,
